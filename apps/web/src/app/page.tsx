...
export default function HomePage() {
  return (
    <>
      ...
      <section className="relative layout-divider-bottom pt-12">
        <div className="page-container">
          <SectionIntro
            badge="Inversión"
            title="Niveles de alcance para decidir más rápido"
            lead="No son precios cerrados. Sirven para que sepas en qué nivel de proyecto estás antes de escribirnos."
            className="mb-0 max-w-3xl"
            titleClassName="mb-4 max-w-2xl"
          />
          ...
          <BorderedGrid gridClassName="grid grid-cols-1 md:grid-cols-3" frameClassName="border-y-0">
            <article className="flex h-full min-h-[17.5rem] flex-col p-5 md:border-r md:border-white/10">
              <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.22em] text-primary/90">Alcance inicial</p>
              <h3 className="text-2xl font-semibold text-white">Base</h3>
              <p className="mt-2 line-clamp-2 text-sm leading-7 text-white/75">
                Para una landing o una versión simple enfocada en una sola oferta.
              </p>
              <ul className="mt-8 space-y-2 text-sm text-muted-foreground">
                <li>Una acción principal.</li>
                <li>Estructura base clara.</li>
                <li>Ideal para salir rápido.</li>
              </ul>
            </article>

            <article className="flex h-full min-h-[17.5rem] flex-col p-5 md:border-r md:border-white/10">
              <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.22em] text-primary/90">Alcance intermedio</p>
              <h3 className="text-2xl font-semibold text-white">Intermedio</h3>
              <p className="mt-2 line-clamp-2 text-sm leading-7 text-white/75">
                Para un sitio corporativo con más recorrido, más contexto y mejor estructura
                comercial.
              </p>
              <ul className="mt-8 space-y-2 text-sm text-muted-foreground">
                <li>Más secciones y jerarquía.</li>
                <li>Recorrido de contacto más completo.</li>
                <li>Ideal para ordenar propuesta y servicios.</li>
              </ul>
            </article>

            <article className="flex h-full min-h-[17.5rem] flex-col p-5">
              <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.22em] text-primary/90">Alcance amplio</p>
              <h3 className="text-2xl font-semibold text-white">Avanzado</h3>
              <p className="mt-2 line-clamp-2 text-sm leading-7 text-white/75">
                Para una estructura más amplia, con más personalización, más capas y continuidad
                técnica.
              </p>
              <ul className="mt-8 space-y-2 text-sm text-muted-foreground">
                <li>Mayor alcance y profundidad.</li>
                <li>Más personalización e integraciones.</li>
                <li>Ideal para una base pensada para crecer.</li>
              </ul>
            </article>
          </BorderedGrid>
          <LayoutWideDivider />
          ...
          <div className="py-12">
            <p className="max-w-4xl text-base leading-8 text-white">
              <span className="text-primary">No es una lista de precios.</span> Es una referencia
              para que puedas ubicar el alcance de tu proyecto antes de hablar con nosotros.
            </p>
          </div>
        </div>
      </section>
